...
const TypeDependency* coral_module_query_dependencies()
{
	static const TypeDependency s_dependencies[] = {
		{ "co.IMethod", "32876DCC-6D48-D53B-E3DEDC93C87AC796" },
		...
		{ "co.IField", "E45AD70F-C1D0-7534-5E3FB49DA2EB9AC7" },
		{ "lua.IInterceptor", "C35DD7EA-DDEA-258D-A9E6CBA856EA565A" },
		...
		{ "lua.IState", "01B7AD9A-76B7-25E3-F77BB2325184A542" },
		{ "co.INativeClass", "1BC29C8D-407C-F5A5-06C69016CF24AD0D" },
		{ "lua.Universe", "5DE15B71-31F7-75D0-4756294D7FC3D9AC" },
