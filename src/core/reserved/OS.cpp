...
bool co::OS::searchFile2( co::ArrayRange<const std::string> listA, co::ArrayRange<const std::string> listB,
						  std::string& path, std::string* partA, std::string* partB )
{
	...
	for( co::ArrayRange<const std::string> itA( listA ); itA; itA.popFirst() )
	{
		for( co::ArrayRange<const std::string> itB( listB ); itB; itB.popFirst() )
		{
...
bool co::OS::searchFile3( co::ArrayRange<const std::string> listA,
						  co::ArrayRange<const std::string> listB,
						  co::ArrayRange<const std::string> listC,
						  std::string& path, std::string* partA, std::string* partB, std::string* partC )
{
	...
	for( co::ArrayRange<const std::string> itA( listA ); itA; itA.popFirst() )
	{
		for( co::ArrayRange<const std::string> itB( listB ); itB; itB.popFirst() )
		{
			for( co::ArrayRange<const std::string> itC( listC ); itC; itC.popFirst() )
			{
				filePath.assign( itA.getFirst() );
				if( *filePath.rbegin() != CORAL_OS_DIR_SEP )
					filePath.push_back( CORAL_OS_DIR_SEP );
