...
public:
	...
	{
		_cookie = _provider->registerProxyInterface( co::disambiguate<co::IService, co::IRecordType>( this ) );
	}
	...
	co::IInterface* getInterfaceType() { return co::typeOf<co::IRecordType>::get(); }
...
public:
	...
	{
		co::IRecordType* p = checkInstance( instance, ai );
		switch( ai->getIndex() )
		{
