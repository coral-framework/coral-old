...
public:
	...
	{
		co::AnyValue res = _provider->dynamicGetField( _cookie, getField<co::IComponent>( 0 ) );
        return res.get< co::Range<co::IPort*> >();
	}

	co::Range<co::IPort*> getPorts()
	{
		co::AnyValue res = _provider->dynamicGetField( _cookie, getField<co::IComponent>( 1 ) );
        return res.get< co::Range<co::IPort*> >();
	}

	co::Range<co::IPort*> getReceptacles()
	{
		co::AnyValue res = _provider->dynamicGetField( _cookie, getField<co::IComponent>( 2 ) );
        return res.get< co::Range<co::IPort*> >();
	}
...
public:
	...
	void getField( co::Any instance, co::IField* field, co::AnyValue& value )
	{
		...
		{
		case 0:		value = p->getFacets(); break;
		case 1:		value = p->getPorts(); break;
		case 2:		value = p->getReceptacles(); break;
