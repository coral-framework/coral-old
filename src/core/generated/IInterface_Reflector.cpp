...
public:
	...
	{
		co::AnyValue res = _provider->dynamicGetField( _cookie, getField<co::IInterface>( 0 ) );
        return res.get< co::IInterface* >();
	}

	co::Range<co::IInterface*> getSubTypes()
	{
		co::AnyValue res = _provider->dynamicGetField( _cookie, getField<co::IInterface>( 1 ) );
...
public:
	...
	void getField( co::Any instance, co::IField* field, co::AnyValue& value )
	{
		...
		{
		case 0:		value = p->getBaseType(); break;
		case 1:		value = p->getSubTypes(); break;
		case 2:		value = p->getSuperTypes(); break;
