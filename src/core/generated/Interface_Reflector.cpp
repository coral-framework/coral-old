/*******************************************************************************
** Reflection code generated for type 'co.Interface'
**
...
public:
	...
	co::Interface* newProxy( co::DynamicProxyHandler* handler )
	{
		...
		return co::disambiguate<co::Interface, co::Interface>( new Interface_Proxy( handler ) );
	}
...
private:
	co::Interface* checkInstance( const co::Any& instance, co::MemberInfo* member )
	{
		...
		return reinterpret_cast<co::Interface*>( instance.getState().data.ptr );
	}
};
