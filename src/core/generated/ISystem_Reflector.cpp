...
public:
	...
	{
		_cookie = _provider->dynamicRegisterService( co::disambiguate<co::IService, co::ISystem>( this ) );
	}
...
public:
	...
	{
		co::ISystem* p = checkInstance( instance, field );
	...
	{
		co::ISystem* p = checkInstance( instance, method );
